...
# ================= general ================= #
CFG.DESCRIPTION = "STDMAE(PEMSD7L) configuration"
CFG.RUNNER = STDMAERunner
CFG.DATASET_CLS = ForecastingDataset
CFG.DATASET_NAME = "PEMSD7L"
...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_tmae_path": "mask_save/TMAE_PEMSD7L_864.pt",
    "pre_trained_smae_path": "mask_save/SMAE_PEMSD7L_864.pt",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
