...
from generate_adj_mx import generate_adj_pemsd7m
...
def generate_data(args: argparse.Namespace):
    ...
    Default settings of PEMSD7M dataset:
    ...
    if add_day_of_week:
        ...
        dow = [(i // steps_per_day) % 5 for i in range(data_norm.shape[0])]
        dow = np.array(dow)
...
if __name__ == "__main__":
    ...
    DATA_FILE_PATH = "datasets/raw_data/{0}/data.npz".format(DATASET_NAME)
    GRAPH_FILE_PATH = "datasets/raw_data/{0}/adj_{0}_distance.pkl".format(DATASET_NAME)
