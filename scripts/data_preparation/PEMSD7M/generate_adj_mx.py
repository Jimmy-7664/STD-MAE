...
def generate_adj_pemsd7m():
    distance_df_filename, num_of_vertices = "datasets/raw_data/PEMSD7M/PEMSD7M.csv", 170
    ...
    with open("datasets/raw_data/PEMSD7M/adj_PEMSD7M.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/PEMSD7M/adj_PEMSD7M_distance.pkl", "wb") as f:
