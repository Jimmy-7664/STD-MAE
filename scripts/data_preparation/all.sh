...
#python scripts/data_preparation/PEMS07/generate_training_data.py --history_seq_len 2016
#python scripts/data_preparation/PEMS08/generate_training_data.py --history_seq_len 2016
#python scripts/data_preparation/PEMS03/generate_training_data.py --history_seq_len 4032
#python scripts/data_preparation/PEMS07/generate_training_data.py --history_seq_len 4032
...
#python scripts/data_preparation/PEMS03/generate_training_data.py --history_seq_len 2016
python scripts/data_preparation/PEMS07/generate_training_data.py --history_seq_len 288
#python scripts/data_preparation/PEMS08/generate_training_data.py --history_seq_len 2016