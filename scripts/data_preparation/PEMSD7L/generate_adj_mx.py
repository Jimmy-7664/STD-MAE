...
def generate_adj_pemsd7l():
    distance_df_filename, num_of_vertices = "datasets/raw_data/PEMSD7L/PEMSD7L.csv", 170
    ...
    with open("datasets/raw_data/PEMSD7L/adj_PEMSD7L.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("datasets/raw_data/PEMSD7L/adj_PEMSD7L_distance.pkl", "wb") as f:
